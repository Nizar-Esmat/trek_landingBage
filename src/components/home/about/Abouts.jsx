    ...
    return (
        <div className="md:flex-row flex flex-col items-center justify-center p-4 md:p-8 my-10">
            ...
            <div className="md:w-1/2 w-full px-2 flex flex-col items-center justify-center gap-9">
                <h1 className="font-bold text-[#F26554] text-6xl text-center py-1">About</h1> {/* Increased to text-6xl */}
                ...
                <button className="px-8 py-4 bg-red-500 rounded-full hover:bg-[#F26554] text-white text-2xl"> {/* Increased padding and text size */}
                    Learn more
                </button>
            </div>

            <div className="md:w-1/2 w-full flex justify-center my-7">
